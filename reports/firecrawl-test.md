Introducing /monitor. Notify your AI agent the moment pages or sites change. [Try it now →](https://docs.firecrawl.dev/features/monitoring)
...
2  {\
3    "url": "9t!p--//axa-=0ea=--",\
4    "markdown": "9 aeA=i-g -?Z-t-d-..",\
5    "json": { "title": "G=ide", "docs": "..." },\
6    "screenshot": "h!Z-saz0*a-!al=90-Z0h-r-.png"\
7  }\
8]
```
...
![User](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-user.png&w=256&q=75&dpl=dpl_4uxsmkEYqczY5BPfxSFZ32uticeL)
